      ...
      <main className="flex-1">
        ...
        <div className="bg-gradient-to-r from-blue-900 to-blue-700 text-white px-6 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">AT ISHARE BUNDLE</h1>
            <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto">
              Stay connected with AT iShare bundles. Enjoy seamless browsing, streaming, and downloading with our affordable and flexible data plans.
            </p>
          </div>
        </div>
